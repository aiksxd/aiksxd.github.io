...
let chessmanCode_0_Cost = 6;    // normal
let chessmanCode_1_Cost = 6;    // move
let chessmanCode_2_Cost = 4;    // trap
let chessmanCode_3_Cost = 4;    // barrier
let gameMode = [0, true];
            ...
            switch (chessman[0]) {
                case 0:
                    ...
                    if (abilityPosition[2].includes(chessman[1])) {
                        ...
                        // cleanTrap
                        let cleanPosition = unavailablePosition.indexOf(chessman[1]);
                        if (cleanPosition !== -1) {
                            unavailablePosition.splice(cleanPosition, 1);
                            positionOwners.splice(cleanPosition, 1);
                        }
                ...
                case 1:
                    ...
                    if (abilityPosition[2].includes(Number(chessman[1][1]))) {
                        let now = new Date();
                        drawChessman([3, Number(chessman[1][1], positionOwners[unavailablePosition.indexOf(Number(chessman[1][0]))], now.getTime())], effect);
                        
                        // cleanTrap
                        let cleanPosition = unavailablePosition.indexOf(Number(chessman[1][1]));
                        if (cleanPosition !== -1) {
                            unavailablePosition.splice(cleanPosition, 1);
                            positionOwners.splice(cleanPosition, 1);
                        }
                        abilityPosition[2].splice(abilityPosition[2].indexOf[Number(chessman[1][1])], 1);
                    ...
                    unavailablePosition[unavailablePosition.indexOf(Number(chessman[1][0]))] = Number(chessman[1][1]);
                    let i = 0;
                    ...
                    availiable_Calculation_Chessman_Types.forEach(availiable_Calculation_Chessman_Type => {
                        if(abilityPosition[availiable_Calculation_Chessman_Type].includes(Number(chessman[1][1]))){
                            winChecker([availiable_Calculation_Chessman_Type, Number(chessman[1][1]), positionOwners[unavailablePosition.indexOf(Number(chessman[1][1]))], NaN]);
                        }
                    });
                    break;
                case 2:
                    ...
                    positionOwners.push(chessman[2]);
                    if(abilityPosition[2] === undefined){
                        abilityPosition[2] = new Array();
                    }
                ...
                case 3:
                    ...
                    unavailablePosition.indexOf(chessman[1])
...
function removeBarrier() {
    ...
    let changePosition = unavailablePosition.indexOf(barrierPosition[0]);   // locate old data
    unavailablePosition.splice(changePosition, 1);
    positionOwners.splice(changePosition, 1);
...
function resetMap() {
    ...
    if (parent) {
        alert("Host reset game map(ready reset too)")
    } else {
